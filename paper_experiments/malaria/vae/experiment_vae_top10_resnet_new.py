...
from paper_experiments.malaria.vae.model_vae import VAE
...
def save_reconstructions(model, d, x, y):
    ...
    with torch.no_grad():
        ...
        save_image(comparison.cpu(),
                   'reconstruction_vae_resnet_new_top10_domain_0_' + str(epoch) + '.png', nrow=8)
...
if __name__ == "__main__":
    ...
    for domain in range(10):
        ...
        model_name = 'vae_top10_test_domain_' + str(domain) + '_seed_' + str(args.seed)
